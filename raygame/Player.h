...
public:
	...
	Player(float x, float y, float health, float damage, float collisionRadius, char icon, float maxSpeed);

	/// <param name="x">Position on the x axis</param>
	/// <param name="y">Position on the y axis</param>
	/// <param name="collisionRadius">The size of the circle surrounding the actor that will be used to detect collisions.</param>
	/// <param name="sprite">That sprite that will be drawn in this actors draw function.</param>
	Player(float x, float y, float health, float damage, float collisionRadius, Sprite* sprite, float maxSpeed);
	...
	/// <param name="maxSpeed">The largest the magnitude of the actors velocity can be.</param>
	Player(float x, float y, float health, float damage, float collisionRadius, const char* spriteFilePath, float maxSpeed);
